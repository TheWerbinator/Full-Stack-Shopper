...
class ShippingForm extends React.Component {
  state = {
    selected: this.props.shippingType,
    error: {},
    lockout: false,
  };
    ...
    switch (type) {
      case "title":
        ...
        this.setState((prevState) => ({
          error: { ...prevState.error, titleError: errorText },
        }));
        break;
      case "name":
        errorText = onlyTextValidation(value);
      ...
      case "cell":
        ...
        this.setState((prevState) => ({
          error: { ...prevState.error, cellError: errorText },
        }));
        break;
      case "telephone":
        errorText = phoneValidation(value);
  ...
  render() {
    ...
    this.state.lockout === true
      ? (btnClass += " proceed-error")
      : (btnClass = "shipping-btn");
    ...
    return (
      <div className='shipping-fields'>
        ...
        <label>
          ...
          />
          {this.state.error.titleError !== null && (
            <div className='shipping-error'>{this.state.error.titleError}</div>
          )}
        </label>
        <label>
          Name - Surname
          <input
            ...
            onBlur={this.handleBlur}
          />
          {this.state.error.nameError !== null && (
            <div className='shipping-error'>{this.state.error.nameError}</div>
          )}
        </label>
        <label>
          Address
        ...
        <div className='selects-1'>
          <label>
            ...
            <input
              ...
              onBlur={this.handleBlur}
            />
            {this.state.error.zipError !== null && (
              <div className='shipping-error'>{this.state.error.zipError}</div>
            )}
          </label>
          <label>
            Country
        ...
        <div>
          <label className='phone'>
            ...
            <input
              ...
              onBlur={this.handleBlur}
            />
            {this.state.error.cellError !== null && (
              <div className='shipping-error'>{this.state.error.cellError}</div>
            )}
          </label>
        </div>
        <hr />
        ...
        <div className='shipping-method'>
          <input
            ...
            checked={this.state.selected === "Free"}
        ...
        <div className='shipping-method'>
          <input
            ...
            id='shipping-express'
            name='shipping-method'
            checked={this.state.selected === "Express"}
            onChange={() => this.handleChange("Express")}
          />
