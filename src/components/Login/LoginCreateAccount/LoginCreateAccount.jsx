...
class CreateAccount extends React.Component {
  ...
  handleValidations = (name, value) => {
    ...
    switch (name) {
      ...
      case "confirmPassword":
        ...
        this.setState((prevState) => ({
          error: { ...prevState.error, passwordConfirmError: errorText },
        }));
        break;
      case "fname":
        errorText = onlyTextValidation(value);
        this.setState((prevState) => ({
          error: { ...prevState.error, fnameError: errorText },
        }));
        break;
      case "lname":
        errorText = onlyTextValidation(value);
        this.setState((prevState) => ({
          error: { ...prevState.error, lnameError: errorText },
        }));
        break;
      case "zip":
  ...
  checkErrorBeforeSave = () => {
    ...
    errorValue.passwordConfirmError ||
    errorValue.fnameError ||
    errorValue.lnameError ||
    errorValue.zipError
      ? (isError = true)
      : (isError = false);
  ...
  render() {
    const { authData, error, maxLength } = this.state;
      ...
      <div>
        <form onSubmit={this.handleAddData}>
          ...
          <div className='btn-wrapper'>
            <p>
              Passwords must have a letter, number, and special character -
              !@#$%
            </p>
